...
class DialoguePolicy:
    ...
    @staticmethod
    def task_ask(task: RuntimeTaskRecord | None, payload: TaskAskPayload) -> str:
    ...
    @staticmethod
    def task_update(task: RuntimeTaskRecord | None, payload: TaskUpdatePayload) -> str:
        prefix = task.title if task is not None else payload.task_id
    ...
    def task_end(self, task: RuntimeTaskRecord | None, payload: TaskEndPayload) -> str:
        prefix = task.title if task is not None else payload.task_id
