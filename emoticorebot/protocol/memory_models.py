"""Memory payload models for the v3 runtime protocol."""
...
class ReflectSignalPayload(ProtocolModel):
    trigger_id: str
...
class MemoryWriteRequestPayload(ProtocolModel):
    request_id: str
...
class MemoryWriteCommittedPayload(ProtocolModel):
    request_id: str
    memory_id: str
    memory_type: MemoryType
...
class MemoryUpdatePayload(ProtocolModel):
    update_id: str
    target: MemoryTarget
    summary: str | None = None
    content: str | None = None
