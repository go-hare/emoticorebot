...
PAYLOAD_MODEL_BY_EVENT_TYPE: dict[str, type[ProtocolModel]] = {
    ...
    EventType.INTENT_SCORED: IntentScoredPayload,
    EventType.LEFT_COMMAND_REPLY_REQUESTED: LeftReplyRequestPayload,
    EventType.LEFT_EVENT_REPLY_READY: LeftReplyReadyPayload,
    EventType.LEFT_EVENT_STREAM_DELTA_READY: LeftReplyReadyPayload,
    EventType.LEFT_EVENT_FOLLOWUP_READY: LeftReplyReadyPayload,
    ...
    EventType.RIGHT_EVENT_JOB_CLARIFY: RightBrainClarifyPayload,
