...
PAYLOAD_MODEL_BY_EVENT_TYPE: dict[str, type[ProtocolModel]] = {
    ...
    EventType.BRAIN_COMMAND_REPLY_REQUESTED: BrainReplyRequestPayload,
    EventType.BRAIN_EVENT_REPLY_READY: BrainReplyReadyPayload,
    EventType.BRAIN_EVENT_STREAM_DELTA_READY: BrainStreamDeltaPayload,
    EventType.EXECUTOR_COMMAND_JOB_REQUESTED: ExecutorJobRequestPayload,
    EventType.EXECUTOR_EVENT_JOB_REJECTED: ExecutorRejectedPayload,
    EventType.EXECUTOR_EVENT_RESULT_READY: ExecutorResultPayload,
